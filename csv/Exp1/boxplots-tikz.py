...
df_cltj_star = pd.read_csv("cltj-asterisco/adaptive/" + l + "type1.cltj.limit"+b+".csv",
						header=None, delimiter=';', names=['id', 'res', 'time'])

df_cltj_star_fix = pd.read_csv("cltj-asterisco/fixed/" + l + "type1.cltj.limit"+b+".csv",
						header=None, delimiter=';', names=['id', 'res', 'time'])
...
df_data['CompactLTJ-star'] = df_cltj_star['time'].div( 1000000.0)
#df_data['CompactLTJ-star-fix'] = df_cltj_star_fix['time'].div( 1000000.0)
...
colors = ['cornflowerblue', 'orange', 'silver', 'chocolate', 'mediumseagreen', 'plum']
colors2 = ['cornflowerblue', 'orange', 'lightblue', 'bisque', 'silver', 'chocolate', 'mediumseagreen', 'plum']
...
df_cltj_fix = pd.read_csv("cltj/fixed/" + l + "type2.cltj.limit"+b+".csv",
						header=None, delimiter=';', names=['id', 'res', 'time'])
df_cltj_star = pd.read_csv("cltj-asterisco/adaptive/" + l + "type2.cltj.limit"+b+".csv",
						header=None, delimiter=';', names=['id', 'res', 'time'])
df_cltj_star_fix = pd.read_csv("cltj-asterisco/fixed/" + l + "type2.cltj.limit"+b+".csv",
						header=None, delimiter=';', names=['id', 'res', 'time'])
...
df_cltj_star = pd.read_csv("cltj-asterisco/adaptive/" + l + "type3.cltj.limit"+b+".csv",
						header=None, delimiter=';', names=['id', 'res', 'time'])

df_cltj_star_fix = pd.read_csv("cltj-asterisco/fixed/" + l + "type3.cltj.limit"+b+".csv",
						header=None, delimiter=';', names=['id', 'res', 'time'])
...
names = ['Ring-l', 'Ring-l-F', 'Ring-s', 'Ring-s-F',
		 'VRing-l', 'VRing-l-F', 'VRing-s', 'VRing-s-F', 
		 'RDFCSA-l', 'RDFCSA-l-F', 'RDFCSA-s', 'RDFCSA-s-F',
		 'CompactLTJ*']
#bpt = [12.15, 7.30, 23.0, 14.61, 40.28, 35.42, 51.65, 42.74, 24.0, 15.81]

bpt = [11.7, 12.4, 6.9, 7.6, 39.9, 40.6, 35.1, 35.8, 24.3, 25, 15.6, 16.3, 41.3]
...
ax1.legend(h, l, ncol=1, fontsize=16, loc='upper right')

#labels, handles = zip(*sorted(zip(labels, handles), key=lambda t: t[0]))
#fig.legend(h, l, ncol=4, fontsize=14, loc='upper center', bbox_to_anchor=[0.5, 1.06])
fig.tight_layout()
#plt.show()
